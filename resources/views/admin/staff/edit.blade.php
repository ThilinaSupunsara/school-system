<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Update details for {{ $staff->user->name }}.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('finance.staff.update', $staff->id) }}" x-data="{ showPassword: false }">
                @csrf
                @method('PUT')
                        ...
                        <div class="p-8 border-b md:border-b-0 md:border-r border-gray-100">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input id="name" type="text" name="name" value="{{ old('name', $staff->user->name) }}" required autofocus
                                ...
                                <div>
                                    ...
                                    <input id="email" type="email" name="email" value="{{ old('email', $staff->user->email) }}" required
                                           class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-purple-500 focus:ring-purple-500 transition-colors sm:text-sm py-3">
                                </div>

                                <div class="border-t border-gray-100 pt-4">
                                    <p class="text-xs text-gray-500 mb-4">Leave the fields below blank if you do not wish to change the password.</p>
                                    ...
                                    <div>
                                        ...
                                        <input id="password_confirmation" :type="showPassword ? 'text' : 'password'" name="password_confirmation" placeholder="••••••••"
                                               class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-purple-500 focus:ring-purple-500 transition-colors sm:text-sm py-3">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-8 bg-gray-50/30">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input id="join_date" type="date" name="join_date" value="{{ old('join_date', $staff->join_date) }}" required
                                           class="w-full rounded-xl border-gray-200 bg-white focus:bg-white focus:border-blue-500 focus:ring-blue-500 transition-colors sm:text-sm py-3">
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input id="basic_salary" type="number" step="0.01" name="basic_salary" value="{{ old('basic_salary', $staff->basic_salary) }}"
