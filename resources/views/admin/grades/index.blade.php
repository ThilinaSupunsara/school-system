    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Configure academic grades (e.g., Grade 1, Grade 13).</p>
            </div>

            <a href="{{ route('finance.grades.create') }}"
                    ...
                    <table class="min-w-full divide-y divide-gray-100">
                        <thead>
                            <tr class="bg-gray-50/50">
                                ...
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Grade Name</th>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200 group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            <a href="{{ route('finance.grades.edit', $grade->id) }}"
                                            ...
                                            <form class="inline-block" method="POST" action="{{ route('finance.grades.destroy', $grade->id) }}">
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-10 text-center text-gray-500">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-base font-medium text-gray-900">No grades found</p>
                                            <p class="text-sm text-gray-500">Get started by creating a new grade.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endif
