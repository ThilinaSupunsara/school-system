    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Update the grade name (e.g. Grade 1).</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                    <h3 class="text-lg font-bold text-gray-900 flex items-center">
                        <span class="bg-indigo-100 text-indigo-600 p-2 rounded-lg mr-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13M3.323 18.253l2.883-1.666m14.614 0l-2.883-1.666M2.883 9.666l2.883 1.666m14.614 0l-2.883-1.666M12 21.086l-2.883-1.666m5.766 0l2.883-1.666M12 3.167L7.333 5.833m9.334 0L12 3.167"></path></svg>
                        </span>
                        Grade Details
                    </h3>
                    <span class="text-xs font-mono text-gray-400 bg-gray-100 px-2 py-1 rounded">ID: {{ $grade->id }}</span>
                </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="name" type="text" name="name" value="{{ old('name', $grade->name) }}" required autofocus
                                ...
                                <p class="mt-2 text-xs text-gray-500">This name will be displayed in all reports and student profiles.</p>
                            </div>
