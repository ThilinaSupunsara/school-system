    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Create a class section under a specific grade.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl shadow-gray-100 sm:rounded-2xl border border-gray-100">
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('finance.sections.store') }}">
                        @csrf
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="name" type="text" name="name" value="{{ old('name') }}" required
                                           ...
                                           placeholder="e.g. A, B, Green, Red">
                                </div>
                                <p class="mt-2 text-xs text-gray-500">Examples: 'A' for Grade 6-A, or 'Green' for Grade 1-Green.</p>
                            </div>
