<x-app-layout>
    ...
    function confirmDelete(event) {
        // Button එක click කළාම form එක auto submit වෙන එක නවත්තනවා
        event.preventDefault();

        // click කරපු button එක අයිති form එක හොයාගන්නවා
        const form = event.target.closest('form');

        // SweetAlert පණිවිඩය පෙන්වනවා
        Swal.fire({
            title: 'Are you sure?',
            ...
            // User 'Yes' බටන් එක click කළොත් විතරක් form එක submit කරනවා
