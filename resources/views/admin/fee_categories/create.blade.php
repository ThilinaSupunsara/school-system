        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-2xl text-gray-800 leading-tight">
                    {{ __('Add New Fee Category') }}
                </h2>
                <p class="text-sm text-gray-500">Define a new type of student fee (e.g. Tuition, Sports, Exam).</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('finance.fee-categories.store') }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <p class="mt-2 text-xs text-gray-500">This name will appear on invoices (e.g. 'Admission Fee', 'Facility Fee').</p>
                            </div>
