                    ...
                    <form method="GET" action="{{ route('finance.reports.salary_sheet') }}">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="flex items-end">
                                ...
                                <a href="{{ route('finance.reports.salary_sheet.pdf', request()->all()) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 h-10">
